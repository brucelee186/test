		...
		$('#datagrid').datagrid({
			...
			columns : [ [
				...
				//},,
					...
					{
						title : '<s:message code="p_main.maintenacte.goods.unitpricermb"/>',
						field : 'unitPrice',
						width : 0.2,
						sortable : false
					},{
						...
						handler : function() {
							...
							$('#form_Goods').form('load', {
								...
								unitPriceForeign:checkedRows[0].unitPriceForeign,
		...
		<table id="datagrid"></table>
			...
			<form id="form_Goods" method="post">
				...
				<table class="tableForm" align="center">
					...
					<tr>
						<td><s:message code="p_main.maintenacte.goods.unitPriceForeign"/>:</td>
						<td><input id="unitPriceForeign" name="unitPriceForeign" class="easyui-numberbox" data-options="min:0,precision:6" style="width: 180px"/></td>
					</tr>
					<tr>
						<td><s:message code="p_main.maintenacte.goods.unitpricermb"/>:</td>
