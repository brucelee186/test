...
function _5bb(a,o,r){
for(var i=0,len=a.length;i<len;i++){
// 修正Uncaught TypeError: Cannot read property 'id' of undefined
if(undefined != a[i] && a[i][o]==r[o]){
return;
}
}
a.push(r);
...
if(col != null && String(col.width||"").indexOf("%")>=0){
...
for(var i=0;i<a.length;i++){
// 修正Uncaught TypeError: Cannot read property 'id' of undefined
if(undefined != a[i] && a[i][opts.idField]==r[opts.idField]){
a[i]=r;
return true;
}
}
