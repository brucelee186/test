...
style='font-size:13.0pt;mso-ascii-font-family:Verdana;mso-hansi-font-family:
Verdana;color:#110043'>领导，您好！</span>
<br/>
<br/>
<span style='font-size:13.0pt;mso-ascii-font-family:Verdana;mso-hansi-font-family:
Verdana;color:#110043'>行政管理平台中，有员工申请五天或五天以上连休假，现已经部门负责人审批和行政审批通过，请您审核。</span><span lang=EN-US style='font-size:
13.0pt;font-family:"Verdana","sans-serif";color:#110043'><br>
<br>
</span>
...
<tbody>
<tr>
	<th width="150">姓名&nbsp;User Name</th>
	<th width="150">部门&nbsp;Department</th>
	<th width="150">假别&nbsp;Vacation Type</th>
	<th width="150">开始时间&nbsp;Start Date</th>
	<th width="150">结束时间&nbsp;End Date</th>
	<th width="150">时长&nbsp;Duration</th>
	<th width="500" style="text-align:left;">备注&nbsp;Remark</th>
</tr>
<tr>
	<td style="text-align:center;">office_userName</td>
	<td style="text-align:center;">office_divisionName</td>
	<td style="text-align:center;">office_nameVacate</td>
	<td style="text-align:center;">office_dateStart</td>
	<td style="text-align:center;">office_dateEnd</td>
	<td style="text-align:center;">office_duration</td>
	<td style="text-align:left;">office_remark</td>
</tr>
</tbody>
</table>
<span style='font-size:13.0pt;mso-ascii-font-family:Verdana;mso-hansi-font-family:
