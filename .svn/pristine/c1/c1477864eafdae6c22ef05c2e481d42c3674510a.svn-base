...
$('#dtg_purchaseItem').edatagrid({
		...
		columns : [ [{
			...
			width : 100,
			align : 'right',
			editor : { type : 'numberbox',options : {required:true, min:0, max:99999, precision:2}}
		}/* ,{
			title : 'LV2 approver',
			field : 'specifiedlv2ApproveUserId',
			width : 100,
			formatter : function(value, row, index) {
				return row.specifiedlv2ApproveUserName;
			}, 
			editor : { type : 'combobox', options : {valueField : 'id', textField:'text', data: p_lv2Approver, panelHeight:'auto', editable:false}  }
		} */,{
			title : '部门',
			field : 'divisionName',
			width : 100
...
<body class="easyui-layout" data-options="fit : true,border : false">
	<div data-options="region:'center',title:'历史采购列表',border:false">
		...
		<input  name="statusGroup" value="${purchase.statusGroup}" type="hidden"/>
			<table class="mtftable">
				...
				<tr>
					...
					<td>:</td>
					<td><select id="cbx_statuses" name="statuses" class="easyui-combobox" style="width:150px" data-options="panelHeight:'auto',editable:false, multiple:true">
	...
	<div id="dlg_purchase" class="easyui-dialog" style="width:650px;height:500px;" data-options="resizable:true,modal:true,closed: true, 
		...
		<table class="mtftable" align="center">
			<tbody>
				<tr><th>指定二级审批人</th>
				<td>:</td>
				<td><select id="cbx_specifiedlv2ApproveUserId" name="specifiedlv2ApproveUserId" class="easyui-combobox" style="width:200px" data-options="panelHeight:'auto',panelMaxHeight:'200',editable:false ">
