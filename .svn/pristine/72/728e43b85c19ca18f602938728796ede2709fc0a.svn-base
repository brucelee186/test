...
<script type="text/javascript">
	...
	function loadGrid() {
		...
		datagrid = $("#datagrid")
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/order/orderCategoryRule/doSearch.do', //请求的数据源
											...
											if (rows.length == 1) {
												$.messager
														.confirm(
																...
																function(r) {
																	if (r) {
																		$.post('${pageContext.request.contextPath}/order/orderCategoryRule/doEdit.do?editState=d',
																				{
																					id : rows[0].id
																				},
																				function(result) {
							...
							onAfterEdit : function(rowIndex, rowData, changes) {
								...
								$.post('${pageContext.request.contextPath}/order/orderCategoryRule/doEdit.do?editState=u',
									{
										id : rowData.id,
										//name : rowData.name,
										amonutLower : rowData.amonutLower,
										amonutUpper : rowData.amonutUpper,
