...
}//MODIFY--START	Wade	2014-01-06 change default messagebox width from 300 to 400
/**
...
*/
win.window({title:_280,noheader:(_280?false:true),width:400,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
//MODIFY--END
setTimeout(function(){
win.window("destroy");
},100);
...
if (_32b.indexOf("tag:")!=-1){
for(var i=0;i<tabs.length;i++){
var tab=tabs[i];
if(tab.panel("options").id==_32b){
if(_32c){
tabs.splice(i,1);
}
return tab;
...
*/
$.fn.numberbox.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:22,disabled:false,value:"",min:0,max:2147483647,precision:0,decimalSeparator:".",groupSeparator:",",prefix:"",suffix:"",filter:function(e){
//MODIFY--END
var opts=$(this).numberbox("options");
if(e.which==45){
...
if(typeof(_6e6) == "string"){
	cc.push(_6e6.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;"));
}else{
	cc.push(_6e6);
}
//MODIFY--END
...
val=row[_812];
*/
val=row[_812]?row[_812].replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;"):row[_812];
//MODIFY--END
}
...
// WADE
span.find("input.combo-text").focus(function () {
if ($(_848).is(":hidden") && $(_847).combo("options").autoShowPanel) { $(_847).combo("showPanel"); }
});

span.find("input.combo-text").keydown(function(event) {
	if (event.keyCode==40 && $(_848).is(":hidden")){
		 $(_847).combo("showPanel");
	}
});
// WADE
...
dd.push("<div id=\""+(_8b9.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
dd.push(opts.formatter?opts.formatter.call(_8b7,row):text);
//MODIFY--END
dd.push("</div>");
