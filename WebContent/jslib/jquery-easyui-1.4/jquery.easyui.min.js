...
if(btn=="-"){
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
//START ADD by WADE.ZHU 2014-12-24
}else if(btn=="--"){
$("<td><div style=\"width:50px;\"></div></td>").appendTo(tr);
}else if(typeof btn=="string"){
$("<td>"+btn+"</td>").appendTo(tr);
//END ADD
}else{
...
//MODIFY--START	SUN	2013-09-27 tree htmlEncode
/**
return node.text;
 */	
return node.text?node.text.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;"):node.text;
//MODIFY--END
...
// MODIFY START Wade.Zhu 2014-08-08 htmlEncode panel title
/*
var _214=$("<div class=\"panel-title\"></div>").html(opts.title).appendTo(_213);
*/
if (opts.title != undefined && opts.title != null){
var title = opts.title.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;");
}
var _214=$("<div class=\"panel-title\"></div>").html(title).appendTo(_213);
// MODIFY END Wade.Zhu
if(opts.iconCls){
...
//ADD START Wade.Zhu 2015-02-02 add vega option
if(opts.tools[i].vega) {
t.attr("vega", opts.tools[i].vega)
}
//ADD END
...
// MODIFY START Wade.Zhu 2014-08-08 html encode panel title
/*
$(_23d).panel("header").find("div.panel-title").html(_23e);
*/
var title = _23e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;");
$(_23d).panel("header").find("div.panel-title").html(title);
// MODIFY END Wade.Zhu
};
var _23f=null;
...
//MODIFY--START	Wade	2014-04-08 change shadow from true to false
/*
...
//MODIFY--START	Wade	2015-01-22 support left/right key swith button focus
/**
$("<a></a>").attr("href","javascript:void(0)").text(_294).css("margin-left",10).bind("click",eval(_293[_294])).appendTo(tb).linkbutton();
*/
$("<a></a>").attr("href","javascript:void(0)").text(_294).css("margin-left",10).bind("click",eval(_293[_294])).bind('keydown', function(e){if(e.keyCode==37){$(this).prev().focus();}else if(e.keyCode==39){$(this).next().focus();}}).appendTo(tb).linkbutton();
//MODIFY--END
}
}
//MODIFY--START	Wade	2014-06-20 change default messagebox width from 300 to 450
/**
...
*/
win.window({title:_291,noheader:(_291?false:true),width:450,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
//MODIFY--END
setTimeout(function(){
win.window("destroy");
},100);
...
//MODIFY--START	Sun	2014-06-10 float left
//var _297="<div>"+msg+"</div>";
//----------
var _297="<div style=\"margin-left:42px;\">"+msg+"</div>";
//MODIFY--END
switch(icon){
case "error":_297="<div class=\"messager-icon messager-error\"></div>"+_297;break;
case "info":_297="<div class=\"messager-icon messager-info\"></div>"+_297;break;
case "question":_297="<div class=\"messager-icon messager-question\"></div>"+_297;break;
case "warning":_297="<div class=\"messager-icon messager-warning\"></div>"+_297;break;
//MODIFY--START	Sun	2014-06-10 float left
default:_297="<div>"+msg+"</div>";break;
//MODIFY--END
}
...
//----------
var _29a="<div class=\"messager-icon messager-question\"></div>"+"<div style=\"margin-left:42px;\">"+msg+"</div>"+"<div style=\"clear:both;\"/>";
//MODIFY--END
var _29b={};
...
//----------
var _29d="<div class=\"messager-icon messager-question\"></div>"+"<div style=\"margin-left:42px;\">"+msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>";
//MODIFY--END
var _29e={};
...
// MODIFY START Wade.Zhu 2014-08-08 htmlEncode tab title
/*
_330.html(opts.title);
*/
var title = opts.title.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;")
_330.html(title);
// MODIFY END Wade.Zhu 2014-08-08
...
//ADD--START	WADE	2014-01-10 search tab by id
//if (_33e.indexOf("tag:")==0){
for(var i=0;i<tabs.length;i++){
var tab=tabs[i];
if(tab.panel("options").id==_33e){
if(_33f){
tabs.splice(i,1);
}
return tab;
...
// MODIFY Wade.Zhu 2014-08-11 change title from &nbsp; to ' '
/*
...
menu.children("div").each(function(){
var item=$(this);
//MODIFY Wade.Zhu 2014-12-10 add hideOnClick property on menu item
/*
var _3c3=$.extend({},$.parser.parseOptions(this,["name","iconCls","href",{separator:"boolean"}]),{disabled:(item.attr("disabled")?true:undefined)});
*/
var _3c3=$.extend({hideOnClick:true},$.parser.parseOptions(this,["name","iconCls","href",{separator:"boolean"},{hideOnClick:"boolean"}]),{disabled:(item.attr("disabled")?true:undefined)});
//END MODIFY Wade.Zhu 2014-12-10 
if(_3c3.separator){
...
//ADD Wade.Zhu 2014-12-10 add hideOnClick property on menu item
item[0].hideOnClick=_3c3.hideOnClick;
//END ADD Wade.Zhu 2014-12-10 
...
if(!this.submenu){
*/
if(!this.submenu && this.hideOnClick){
// WADE ZHU END
_3cf(_3d0);
...
// ADD wade.zhu 2014-08-06 bugfix textbox created by textarea cannot load data
...
//MODIFY--START	Wade	2014-01-20 change default numberbox min,max property from null,null to 0,2147483647, groupSeparator from "" to ","
/**
}},min:null,max:null,precision:0,decimalSeparator:".",groupSeparator:"",prefix:"",suffix:"",filter:function(e){
*/
}},min:0,max:2147483647,precision:0,decimalSeparator:".",groupSeparator:",",prefix:"",suffix:"",filter:function(e){
//END MODIFY
...
// START OVERWRITE by WADE.ZHU 2014-06-25
/*
if(opts.ctrlSelect){
if(e.ctrlKey){
...
if (e.ctrlKey) {
	...
	if (e.shiftKey){
		var arr = $(_5ba).datagrid('getSelections');
		if (arr.length > 0) {
			var prevRowIndex = $(_5ba).datagrid('getRowIndex', arr[arr.length - 1]);
			var nowRowIndex = $(_5ba).datagrid('getRowIndex', row);
			$(_5ba).datagrid("clearSelections");
			if (prevRowIndex < nowRowIndex) {
				for (var l = prevRowIndex; l <= nowRowIndex; l ++) {
					$(_5ba).datagrid('selectRow', l);
				}
			} else {
				for (var l = prevRowIndex; l >= nowRowIndex; l --) {
					$(_5ba).datagrid('selectRow', l);
			...
			var slct = document.selection==undefined?document.getSelection():document.selection; 
			slct.empty==undefined?slct.removeAllRanges():slct.empty();
		}
	}
}else{
	$(_5ba).datagrid("clearSelections");
...
//MODIFY--START	SUN	2013-09-27 datagrid htmlEncode
/**
cc.push(_728);
 */
if(typeof(_728) == "string"){
	cc.push(_728.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;"));
}else{
	cc.push(_728);
}
//MODIFY--END
...
//MODIFY--START	SUN	2013-09-27 datatree html encode
//val=row[_864];
if(row[_864] && typeof(row[_864]) == "string"){
	val=row[_864].replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;");
} else {
	val=row[_864];
}
//MODIFY--END
...
// MODIFY START wade.zhu 2014-08-06 bugfix combo value select
/*
var v=_8f0[i];
*/
var v=_8f0[i] == null ? null : _8f0[i] + '';
// MODIFY END
var s=v;
...
//MODIFY--START	SUN	2013-09-27 combobox htmlEncode
/**
dd.push("<div id=\""+(_8f6.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
dd.push(opts.formatter?opts.formatter.call(_8f4,row):s);
*/
var text = s;
if(!opts.formatter && text && typeof(text) == "string"){
	text = text.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;");
}
dd.push("<div id=\""+(_8f6.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
dd.push(opts.formatter?opts.formatter.call(_8f4,row):text);
//MODIFY--END
dd.push("</div>");
