...
var _218=$("<div class=\"panel-title\"></div>").html(title).appendTo(_217);
// MODIFY END Wade.Zhu
if(opts.iconCls){
...
*/
var title = _243.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;");
$(_242).panel("header").find("div.panel-title").html(title);
// MODIFY END Wade.Zhu
};
var _244=null;
...
*/
win.window({title:_297,noheader:(_297?false:true),width:450,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
//MODIFY--END
setTimeout(function(){
win.window("destroy");
},100);
...
//----------
var _29d="<div style=\"margin-left:42px;\">"+msg+"</div>";
//MODIFY--END
switch(icon){
case "error":_29d="<div class=\"messager-icon messager-error\"></div>"+_29d;break;
case "info":_29d="<div class=\"messager-icon messager-info\"></div>"+_29d;break;
case "question":_29d="<div class=\"messager-icon messager-question\"></div>"+_29d;break;
case "warning":_29d="<div class=\"messager-icon messager-warning\"></div>"+_29d;break;
//MODIFY--START	Sun	2014-06-10 float left
default:_29d="<div>"+msg+"</div>";break;
//MODIFY--END
}
...
//----------
var _2a0="<div class=\"messager-icon messager-question\"></div>"+"<div style=\"margin-left:42px;\">"+msg+"</div>"+"<div style=\"clear:both;\"/>";
//MODIFY--END
var _2a1={};
...
//----------
var _2a3="<div class=\"messager-icon messager-question\"></div>"+"<div style=\"margin-left:42px;\">"+msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>";
//MODIFY--END
var _2a4={};
...
//if (_345.indexOf("tag:")==0){
for(var i=0;i<tabs.length;i++){
var tab=tabs[i];
if(tab.panel("options").id==_345){
if(_346){
tabs.splice(i,1);
}
return tab;
...
if (!f.length) f=$(_4c0).find("textarea["+p+"Name=\""+name+"\"]");
// ADD END
if(f.length){
f[p]("setValue",val);
_4c7+=f.length;
...
if(typeof(_73f) == "string"){
	cc.push(_73f.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;"));
}else{
	cc.push(_73f);
}
//MODIFY--END
...
val=row[_8a6];
*/
val=row[_8a6]?row[_8a6].replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/>/g,"&gt;").replace(/</g,"&lt;"):row[_8a6];
//MODIFY--END
}
...
dd.push("<div id=\""+(_93a.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
dd.push(opts.formatter?opts.formatter.call(_938,row):text);
//MODIFY--END
dd.push("</div>");
