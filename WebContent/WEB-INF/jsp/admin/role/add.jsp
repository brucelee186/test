...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		$('#form').form({
			url : '${pageContext.request.contextPath}/admin/role/doAdd.do',
			onSubmit: function() {
			...
			success : function(result) {
				...
				try {
					...
					if (r.success) {
						...
						$.messager.alert('<s:message code="common.dialog.tip" />', 'OK', 'info', function(r) {
							if (goEditActions) {
								var content = formatString('<iframe src="${pageContext.request.contextPath}/admin/role/toEditActions.do?actionId={0}" frameborder="0" style="border : 0; width : 100%; height : 99%;"></iframe>', result.obj.id);
								top.layout_center_addTab({
									title : formatString('Edit Role [{0}] Actions', result.obj.name),
									closable : true,
									iconCls : 'icon-ruby-add',
									content : content
								});
							}
						});
