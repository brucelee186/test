...
/* 	{
	...
	function loadGrid() {
		...
		datagrid = $("#datagrid")
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/attendance/attenVacate/doSearch.do?tagType=m', //请求的数据源
							...
							}, */
							{
								...
								title : '单位',
								width : 100,
								formatter : unitformatterComboUnit,
								align : 'center',
								editor : {
									type : 'combobox',
									options : {
											...
											if (rows.length == 1) {
												$.messager
														.confirm(
																...
																function(r) {
																	if (r) {
																		$.post('${pageContext.request.contextPath}/attendance/attenVacate/doEdit.do?editState=d',
																				{
																					id : rows[0].id
																				},
																				function(result) {
							...
							onAfterEdit : function(rowIndex, rowData, changes) {
								...
								$.post('${pageContext.request.contextPath}/attendance/attenVacate/doEdit.do?editState=u',
									{
										id : rowData.id,
										name : rowData.name,
	...
	function loadDetailGrid(idMain) {
		var datagridDetail; //定义全局变量datagrid
		var editRow = undefined; //定义全局变量：当前编辑的行
		datagridDetail = $("#datagridDetail")
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/attendance/attenVacate/doSearch.do?pid=' + idMain, //请求的数据源
							iconCls : 'icon-save', //图标
							pagination : true, //显示分页
							pageSize : 10, //页大小
							pageList : [ 10, 30, 45, 60 ], //页大小下拉选项此项各value是pageSize的倍数
						...
						/* 	{
								field : 'dayVacateAhead',
								title : '请假提前时长',
								width : 100,
								formatter : formatterDayVacateAhead,
								align : 'center',
								editor : {
									type : 'combobox',
									options : {
										data : comboDayVacateAhead,
										valueField : "value",
										textField : "text",
										required : true,
										editable : false,
							...
							}, */
							{
								...
								title : '审批等级',
								width : 100,
								formatter : formatterApproveLevel,
								align : 'center',
								editor : {
									type : 'combobox',
									options : {
										data : comboApproveLevel,
										valueField : "value",
										textField : "text",
										required : true,
										editable : false,
						...
						/* 	{
							...
							onAfterEdit : function(rowIndex, rowData, changes) {
								...
								$.post('${pageContext.request.contextPath}/attendance/attenVacate/doEdit.do?editState=u&pid=' + idMain,
									{
										id : rowData.id,
										name : rowData.name,
										duration : rowData.duration,
										...
										tagProve : rowData.tagProve,
										tagType : 'd',
										dayStart : rowData.dayStart,
										dayEnd : rowData.dayEnd,
									},
									function(result) {
