package framework.JDBC.Transaction;
...
public class Test {
	public static void main(String[] args) {
		...
		try {
			...
			statement.execute("INSERT INTO jdbc (name) VALUES ('god')");
			ResultSet resultSet = statement.executeQuery("SELECT * FROM jdbc");
			while (resultSet.next()) {
				System.err.println("ID = " + resultSet.getInt("ID") + " name = " + resultSet.getNString("name"));
			}
