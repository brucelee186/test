...
public class TextUtils {
	...
	public static void getChars(CharSequence s, int start, int end, char[] dest, int destoff) {
		...
		if (c == String.class) ((String) s).getChars(start, end, dest, destoff);
		else if (c == StringBuffer.class) ((StringBuffer) s).getChars(start, end, dest, destoff);
		else if (c == StringBuilder.class) ((StringBuilder) s).getChars(start, end, dest, destoff);
		else {
	...
	public static int indexOf(CharSequence s, char ch, int start) {
		...
		if (c == String.class) return ((String) s).indexOf(ch, start);
	...
	public static int indexOf(CharSequence s, char ch, int start, int end) {
		...
		if (c == StringBuffer.class || c == StringBuilder.class || c == String.class) {
	...
	public static int lastIndexOf(CharSequence s, char ch, int last) {
		...
		if (c == String.class) return ((String) s).lastIndexOf(ch, last);
	...
	static char[] obtain(int len) {
		...
		if (buf == null || buf.length < len) buf = new char[ArrayUtils.idealCharArraySize(len)];
	 ...
	 * @return true if str is null or zero length
	 */
	public static boolean isEmpty(CharSequence str, Json j, String msg) {
	 ...
	 * Returns whether the given CharSequence contains only digits.
	 */
	public static boolean isDigitsOnly(String str, Json j, String msg) {
